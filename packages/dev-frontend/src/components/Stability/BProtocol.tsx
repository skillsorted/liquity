...
export const BProtocol: React.FC = () => {
  ...
  return (
    <Card>
      <Heading>
          Stability Pool using B.Protocol
      </Heading>
      <Box sx={{ p: [2, 3] }}>
        You can earn <b>LUSD</b> and <b>LQTY</b> rewards by depositing LUSD.

        <Flex variant="layout.actions">
          < LinkTo variant="bprotocol"  activeClassName="active" to="/b-protocol?hideNav=true">
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="34" height="24" viewBox="0 0 34 24" fill="currentcolor" style={{"verticalAlign":"-3px"}} >
                  <defs>
