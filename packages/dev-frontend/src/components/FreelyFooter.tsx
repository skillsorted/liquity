    ...
    <div className="u-layout-row">
      ...
      <div className="u-align-left u-container-style u-layout-cell u-size-20 u-layout-cell-3">
        <div className="u-container-layout u-container-layout-3">
          <h6 className="u-custom-font u-text u-text-default u-text-3"><b>Contact us</b>
          </h6>
          <a href="mailto:contact@freely.finance" target="_blank" className="u-align-left u-btn u-button-style u-none u-text-hover-custom-color-3 u-text-palette-1-base u-btn-4">contact@freely.finance</a>
        </div>
      </div>
    </div>
  </div>
